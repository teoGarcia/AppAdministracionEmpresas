...
public class PanelImprimirDoc extends JPanel implements Printable{
	...
	public PanelImprimirDoc() {
		...
		lblTipoDoc = new JLabel("FACTURA ELECTRONICA");
		...
		JLabel lblNewLabel_2_4_1_2 = new JLabel("TIPO DE COMP:");
		lblNewLabel_2_4_1_2.setFont(new Font("Dialog", Font.BOLD, 9));
		lblNewLabel_2_4_1_2.setBounds(70, 233, 74, 22);
		...
		lblNewLabel_2_4_1_4_2.setBounds(391, 115, 80, 22);
		...
		lblTipoCompra = new JLabel("800.000.000");
		lblTipoCompra.setHorizontalAlignment(SwingConstants.LEFT);
		lblTipoCompra.setFont(new Font("Dialog", Font.PLAIN, 9));
		lblTipoCompra.setBounds(149, 233, 141, 22);
		add(lblTipoCompra);
		...
		lblFechaE.setBounds(463, 115, 69, 22);
		add(lblFechaE);
	...
	public void setLblRazonSocial(JLabel lblRazonSocial) {
		this.lblSenores = lblRazonSocial;
	}
	...
	public void setLblTipoCompra(JLabel lblTipoCompra) {
		this.lblTipoCompra = lblTipoCompra;
	}
	...
	public void setLblTipoDoc(JLabel lblTipoDoc) {
		this.lblTipoDoc = lblTipoDoc;
	}
}
