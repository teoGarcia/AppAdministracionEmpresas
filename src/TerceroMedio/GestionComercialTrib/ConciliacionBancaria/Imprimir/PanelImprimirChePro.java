...
public class PanelImprimirChePro extends JPanel implements Printable{
	...
	public PanelImprimirChePro() {
		...
		lblTitulo = new JLabel("Cheques propios");
		...
		String[] columns = new String[] { "Fecha Salida", "Proveedor", "Nro Factura", "Fecha pago", "Titular",
				"Banco Emision","$ Monto"};
