...
@Entity
public class CalendarioProduccion3 {
	...
	public CalendarioProduccion3(Long id, String projecto, String etapa, Calendar fechaI, Calendar fechaT) {
		super();
		this.id = id;
		this.projecto = projecto;
		this.etapa = etapa;
