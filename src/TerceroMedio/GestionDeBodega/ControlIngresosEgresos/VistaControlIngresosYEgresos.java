...
public class VistaControlIngresosYEgresos extends JPanel {
	...
	private ControladorControlIngresoEgreso control;
	 ...
	 * Create the panel.
	 */
	public VistaControlIngresosYEgresos() {
		
		control = new ControladorControlIngresoEgreso(this);
