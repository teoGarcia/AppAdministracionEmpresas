...
public class VistaFormatoProductos extends JPanel {
	 ...
	 * Create the panel.
	 */
	public VistaFormatoProductos() {
		
		ccp = new ControlCodificacionFormProductos(this);
	...
	public void cargarForm(CodificacionFormProdEntity cpe) {
		ccp.setId(cpe.getId());
