...
@Entity
public class CodificacionFormProdEntity {
		...
		public CodificacionFormProdEntity(Long id, String proveedor, String descripProducto, String codIntProducto,
		...
		public CodificacionFormProdEntity() {
			super();
