package TerceroMedio.GestionDeBodega.FormatoProducto.Imprimir;
...
import TerceroMedio.GestionDeBodega.FormatoProducto.CodificacionFormProdEntity;
import core.Helpers;
...
public class PanelImprimir extends JPanel implements Printable{
	...
	public void cargarForm(CodificacionFormProdEntity record) {
