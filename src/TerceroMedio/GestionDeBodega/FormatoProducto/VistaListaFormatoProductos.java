...
public class VistaListaFormatoProductos extends JPanel {
	
	private ControlListaFormatoProductos clp;
	
	private TableStandard table;
	//private JTable table;
	private StandarButton btnEliminar;
	private StandarButton stndrbtnActualizar;
	private ControlCodificacionFormProductos ccp;
	 ...
	 */
	public VistaListaFormatoProductos(ControlCodificacionFormProductos ccp) {
		
		this.ccp = ccp;
		clp = new ControlListaFormatoProductos(this);
	...
	public ControlListaFormatoProductos getClp() {
		return clp;
	}


	public void setClp(ControlListaFormatoProductos clp) {
		this.clp = clp;
	}


	public ControlCodificacionFormProductos getCcp() {
		return ccp;
	}


	public void setCcp(ControlCodificacionFormProductos ccp) {
		this.ccp = ccp;
	}
