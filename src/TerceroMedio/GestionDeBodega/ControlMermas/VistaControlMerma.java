...
public class VistaControlMerma extends JPanel {
	...
	private ControladorControlMerma cmm;
	 ...
	 * Create the panel.
	 */
	public VistaControlMerma() {
		
		cmm = new ControladorControlMerma(this);
	...
	public void CargarForm(ControlMermaEntity mme, int indexTMov, int indexMotivo, int indexUM) {
