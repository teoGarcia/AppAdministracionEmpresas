...
public class ImprimirLiquidacion extends JPanel implements Printable{
	...
	public ImprimirLiquidacion() {
		...
		lblAsiCol_1.setBounds(454, 502, 75, 16);
		add(lblAsiCol_1);
