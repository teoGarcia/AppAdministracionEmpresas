...
public class VistaSeleccionPersonal extends JPanel {
	...
	public VistaSeleccionPersonal() {
		...
		txtApeMat.setBounds(617, 103, 147, 23);
		add(txtApeMat);
		
		txtDom = new JTextField();
		txtDom.setColumns(10);
		txtDom.setBounds(617, 140, 147, 23);
		add(txtDom);
		...
		cbSex.setBounds(617, 181, 147, 23);
		add(cbSex);
		...
		txtAno.setBounds(678, 260, 86, 23);
		add(txtAno);
		...
		cbPra.setBounds(576, 333, 188, 23);
		add(cbPra);
		...
		txtCur4.setBounds(624, 407, 140, 23);
		add(txtCur4);
		...
		txtPueAnt.setBounds(617, 485, 147, 23);
		add(txtPueAnt);
		...
		txtSue.setBounds(617, 522, 147, 23);
		add(txtSue);
