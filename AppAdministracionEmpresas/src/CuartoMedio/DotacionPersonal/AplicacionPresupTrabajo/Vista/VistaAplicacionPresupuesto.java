...
public class VistaAplicacionPresupuesto extends JPanel {
	...
	public VistaAplicacionPresupuesto() {
		...
		lblNewLabel_2.setBounds(255, 68, 81, 22);
		add(lblNewLabel_2);
		
		JLabel lblNewLabel_2_1 = new JLabel("Depto. o Grupo");
		lblNewLabel_2_1.setForeground(Color.WHITE);
		lblNewLabel_2_1.setFont(new Font("Dialog", Font.PLAIN, 12));
		lblNewLabel_2_1.setBounds(515, 68, 88, 22);
		add(lblNewLabel_2_1);
		
		textField = new JTextField();
		textField.setBounds(125, 68, 125, 22);
		add(textField);
		textField.setColumns(10);
		
		textField_1 = new JTextField();
		textField_1.setColumns(10);
		textField_1.setBounds(361, 68, 125, 22);
		add(textField_1);
		
		textField_2 = new JTextField();
		textField_2.setColumns(10);
		textField_2.setBounds(628, 68, 125, 22);
		add(textField_2);
		...
		lblNewLabel_2_3.setBounds(255, 172, 145, 22);
		add(lblNewLabel_2_3);
		
		textField_8 = new JTextField();
		textField_8.setColumns(10);
		textField_8.setBounds(361, 172, 125, 22);
		add(textField_8);
		
		JLabel lblNewLabel_2_1_2 = new JLabel("Expiracion Public.");
		lblNewLabel_2_1_2.setForeground(Color.WHITE);
		lblNewLabel_2_1_2.setFont(new Font("Dialog", Font.PLAIN, 12));
		lblNewLabel_2_1_2.setBounds(515, 172, 118, 22);
		add(lblNewLabel_2_1_2);
		
		JDateChooser dateChooser = new JDateChooser();
		dateChooser.setBounds(125, 174, 125, 20);
		add(dateChooser);
		
		JDateChooser dateChooser_1 = new JDateChooser();
		dateChooser_1.setBounds(628, 174, 125, 20);
		add(dateChooser_1);
